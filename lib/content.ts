...
const dictionaries = {
  ar: {
    ...
    reservation: {
      title: "احصل على استشارتك المجانية الآن",
  ...
  fr: {
    ...
    reservation: { title: "Commençons à créer votre voyage au Maroc.", intro: "Partagez l’essentiel et un spécialiste voyage vous contactera pour comprendre vos envies et façonner un voyage à votre rythme.", note: "Votre première consultation est gratuite et sans engagement.", fullName: "Nom complet *", phone: "Numéro de téléphone *", destination: "Destination", hotelLevel: "Catégorie d’hôtel", stars: "étoiles", travelStyle: "Style de voyage", styles: ["Famille", "Lune de miel", "Aventure", "Détente", "Culture", "Shopping"], submit: "Obtenez votre consultation gratuite dès maintenant", submitting: "Envoi de votre demande…", successTitle: "Votre demande a bien été reçue.", successBody: "Merci. Un spécialiste Akheel vous contactera pour vous aider à créer votre voyage.", error: "Votre demande n’a pas pu être envoyée. Veuillez réessayer." },
